...
static const char *const yytname[] =
{
  ...
  "MINUS", "MULTIPLY", "DIVIDE", "MODULUS", "LPAREN", "RPAREN", "NEWLINE",
  "UMINUS", "$accept", "program", "expression", YY_NULLPTR
};
...
{
      -5,    10,    -5,    -5,     9,     9,    16,    -5,    24,     9,
       9,     9,     9,     9,    -5,    -5,    29,    29,    -5,    -5,
      -5
};
...
#line 1173 "y.tab.c"
  ...
  case 8: /* expression: expression MODULUS expression  */
#line 30 "calc.y"
                                     { yyval = yyvsp[-2] % yyvsp[0]; }
#line 1179 "y.tab.c"
    break;
